        ...
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style:
                            TextStyle(fontSize: 13, color: Color(0xFF991B1B)),
                      ),
                    ),
                  ],
                ),
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [
                DropdownMenuItem(
                    value: "UNEXCUSED_MISSED_CHECKIN",
                    child: Text("غیر حاضر حاضری / Unexcused Missed Check-In")),
                DropdownMenuItem(
                    value: "TRAVEL_RESTRICTION_BREACH",
                    child:
                        Text("نقل و حرکت کی حد کی خلاف ورزی / Travel Breach")),
                DropdownMenuItem(
                    value: "REHAB_NON_ATTENDANCE",
                    child: Text(
                        "اصلاحی پروگرام میں عدم حاضری / Rehab Program Breach")),
              ],
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                labelText:
                    "تفصیل اور ثبوت / Incident Description & Evidence Notes",
                border: OutlineInputBorder(),
              ),
            ),
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                      content:
                          Text("Violation Submitted for Supervisory Review")),
                );
              },
              child: const Text("منظوری کے لیے بھیجیں / Submit for Review",
